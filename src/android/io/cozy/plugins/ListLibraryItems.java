...
public class ListLibraryItems extends CordovaPlugin {
	...
	public boolean execute(String action, JSONArray args, CallbackContext callbackContext) throws JSONException {
		...
		if ("isAuthorized".equals(action)) {
			...
			this.listItems(args.getBoolean(0), args.getBoolean(1), args.getBoolean(2), callbackContext);
			return true;
		}
	...
	private void listItems(boolean includePictures, boolean includeVideos, boolean includeCloud,CallbackContext callbackContext) {
